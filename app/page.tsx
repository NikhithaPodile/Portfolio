...
export default function Portfolio() {
    ...
    >
      ...
      <nav className="fixed left-0 top-0 h-full w-16 md:w-20 z-40 flex flex-col items-center justify-between py-4 md:py-8">
        ...
        <div className="flex flex-col space-y-4">
          <a
            href="https://github.com/NikhithaPodile"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/nikhitha-podile-793a02238/"
            target="_blank"
            rel="noopener noreferrer"
            className={`p-2 transition-all duration-300 hover:scale-110 hover:rotate-12 ${
              isDarkMode ? "text-gray-400 hover:text-white" : "text-gray-600 hover:text-black"
          ...
          />
                ...
                <div className="space-y-4">
                  ...
                  <p className={`text-lg md:text-xl lg:text-2xl font-light $$
                    ...
                    Aspiring Software Engineer experiences with modern technologies
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8 pt-8">
                ...
                >
                  <a href="/Nikhitha_Resume.pdf" download="Nikhitha_Resume.pdf">
  ...
  status: "Current",
                },
                {
                  ...
                  subtitle: "Internship",
                  company: "Aamazon Web Services",
                  period: "Dec 2022 - Feb 2023",
                 description:
    "Worked with AWS analytics tools, helped with data collection and cleansing, and supported projects involving data analysis and visualization. Developed reports to support decision-making and worked with teams to provide insights where I have improved my knowledge of cloud computing and data analytics.",
  status: "Current",
                },
                {
                 ...
                 description:
    "I developed a Weather Prediction Website, a portfolio website, and a Netflix-like homepage using HTML and CSS. These projects enhanced my skills in web development and responsive design.",
  status: "Current",
                },
              ...
              {[
                {
                  ...
                  description:
                    "Facilitated communication, networking, and engagement among college alumni by developing features like alumni directories, event management, job posting, mentorship programs, and fundraising tools to strengthen alumni connections and support for their alma mate",
                  tech: ["Web Development", "Backend Development"],
                  year: "2024",
                  status: "Live",
                },
                {
                  title: "Secure and Robust Data Hiding",
                  description:
                    "The main concept of project revolves around steganography, which involves embedding hidden data within RGB images in a secure and robust manner. This includes ensuring that the embedded data is imperceptible to human eyes, resistant to tampering or distortion, and securely retrievable without compromising the image's quality.",
                  tech: ["CNN", "Deep Learning", "Steganography"],
                  year: "2025",
                  status: "Live",
                },
              ].map((project, index) => (
                ...
                >
                  ...
                  >
                    <CardContent className="p-8">
                      ...
                      >
                        <a href="https://github.com/NikhithaPodile" target="_blank" rel="noopener noreferrer">
                          View Project
            ...
            <div className="space-y-16">
              ...
              >
                <p className={`text-2xl leading-relaxed font-light ${isDarkMode ? "text-gray-300" : "text-gray-700"}`}>
                  I'm pursuing a Bachelor of Technology in the field of Computer Science and Engineering at Vasireddy Venkatadri Institute of Technology,I’m driven by a strong commitment to enhance my professional skills and grow continuously in a dynamic work environment. I’m eager to take on a role where I can both learn new things and effectively apply my knowledge and experience to contribute to the company's daily operations.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-6">
                  {[
                    ...
                    {name: "AI/ML", icon: "🧠", category: "AI/ML"},
                  ].map((skill, index) => (
                    <div
                      key={skill.name}
              ...
              <div className="grid md:grid-cols-2 gap-12">
                  ...
                  <div className="space-y-4">
                    <div className={`p-4 rounded-lg ${isDarkMode ? "bg-gray-900/50" : "bg-gray-50"}`}>
                      ...
                      <p className={`${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
                        V.V.I.T (2021-Present)
                      </p>
                      <p className={`text-sm ${isDarkMode ? "text-gray-500" : "text-gray-500"}`}>CGPA: 8.78/10.0</p>
                    </div>
                    <div className={`p-4 rounded-lg ${isDarkMode ? "bg-gray-900/50" : "bg-gray-50"}`}>
                      <h4 className="font-medium">Intermediate</h4>
                      <p className={`${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>B.S.R IIT ACADEMY (95%)</p>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="space-y-3">
                    {["Web development", "Salesforce", "AWS", "Modern Web Technologies"].map(
                      (interest, index) => (
                        <div
                          key={interest}
                ...
                {[
                  {
                    icon: Mail,
                    label: "Email",
                    value: "podilenikhitha@gmail.com",
                    href: "mailto:podilenikhitha@gmail.com",
                  },
                  { icon: Phone, label: "Phone", value: "+91 9951264022", href: "tel:+919951264022" },
